...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~nmoyzZyZ#9i6lAZA9GWQcPFKZey9TZI-KkotqUZvHwkk5i8Q2S5c", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "+27 83 314 7400", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "*JONTALA MD V7", // Input Yours custom...(Maintain font for Flow)
PREFIX: process.env.PREFIX || ".",
ANTIDELETE: process.env.ANTIDELETE || "true",
ANTICALL: process.env.ANTICALL || "true",
ANTICALL_MSG: process.env.ANTICALL_MSG || "*_📞 Auto Call Reject Mode Activated by Jontala-Md. 📵 No Calls Allowed Dude!_*",
